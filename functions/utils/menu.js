...
export function buildMenuJsonLd(sections) {
  ...
  // @graph so the menu is tied to the same business/website entity as the
  // homepage (shared @ids), plus a WebPage + BreadcrumbList for this URL.
    ...
    "@graph": [
      {
        ...
        description: `The full menu at ${VENUE.name}: espresso and specialty drinks, cocktails, wine, food and desserts. Mason, OH.`,
        isPartOf: { "@id": SITE + "/#website" },
        about: { "@id": SITE + "/#business" },
        inLanguage: "en-US",
        breadcrumb: { "@id": SITE + "/menu#breadcrumb" },
      },
      {
        "@type": "BreadcrumbList",
        "@id": SITE + "/menu#breadcrumb",
        itemListElement: [
...
function itemRow(it) {
  ...
  const price = pr ? `<span style="color:#ad3829;font-weight:500;font-size:.92rem;white-space:nowrap;">${he(pr)}</span>` : "";
  const desc = it.desc ? `<p style="font-size:.78rem;color:rgba(26,22,17,.66);line-height:1.55;margin-top:.28rem;">${he(it.desc)}</p>` : "";
...
function sectionBlock(s) {
  ...
  const group = s.group ? `<p style="font-size:.62rem;letter-spacing:.3em;text-transform:uppercase;color:#ad3829;font-weight:600;margin-bottom:1.1rem;">${he(s.group)}</p>` : "";
...
export function buildMenuPage(sections) {
  ...
  const body = hasMenu
    ...
    : `<p style="text-align:center;color:rgba(26,22,17,.66);padding:4rem 1rem;font-style:italic;font-size:1.2rem;">Menu coming soon.</p>`;
  return `<!doctype html><html lang="en"><head>
<meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1">
<title>Menu — Coffee, Cocktails &amp; Wine in Mason, Ohio | ${he(VENUE.name)}</title>
<meta name="description" content="The full menu at ${he(VENUE.name)}: espresso and specialty drinks, cocktails, wine, food and desserts. 125 E Main St, Mason, OH.">
<link rel="canonical" href="${SITE}/menu">
<meta property="og:title" content="Menu — ${he(VENUE.name)}">
<meta property="og:description" content="Espresso and specialty drinks, cocktails, wine, food and desserts. Mason, Ohio.">
<meta property="og:type" content="website">
<meta property="og:url" content="${SITE}/menu">
...
<meta name="twitter:title" content="Menu — ${he(VENUE.name)}">
<meta name="twitter:description" content="Espresso and specialty drinks, cocktails, wine, food and desserts. Mason, Ohio.">
...
<aside class="mn-rail" style="position:fixed;top:0;left:0;bottom:0;width:88px;z-index:150;background:#e7dece;border-right:1px solid rgba(26,22,17,.16);display:flex;flex-direction:column;align-items:center;justify-content:space-between;padding:1.8rem 0;">
  ...
  <a href="/live" style="writing-mode:vertical-rl;transform:rotate(180deg);font-size:.56rem;letter-spacing:.3em;text-transform:uppercase;color:rgba(26,22,17,.66);">Live &nearr;</a>
</aside>
...
<div class="mn-topbar" style="position:fixed;top:0;left:0;right:0;z-index:150;background:rgba(231,222,206,.96);backdrop-filter:blur(12px);border-bottom:1px solid rgba(26,22,17,.14);align-items:center;justify-content:space-between;padding:.9rem 1.4rem;height:60px;">
  ...
  <a href="http://adessocoffee.square.site" target="_blank" rel="noopener" style="font-size:.6rem;letter-spacing:.2em;text-transform:uppercase;background:#ad3829;color:#f2ecdf;border-radius:999px;padding:.5rem .9rem;">Order</a>
</div>
...
<main class="mn-main">
  <div class="mn-pad" style="max-width:1060px;margin:0 auto;padding:5rem 3rem 6rem;">
    ...
    <header style="margin-bottom:2rem;">
      <p style="font-size:.62rem;letter-spacing:.34em;text-transform:uppercase;color:#ad3829;font-weight:600;margin-bottom:1.1rem;">Adesso Spirits + Espresso</p>
      <h1 class="mn-h1" style="font-weight:400;font-size:clamp(3.4rem,9vw,7rem);line-height:.92;letter-spacing:-.03em;">The <span style="font-style:italic;color:#ad3829;">Menu</span></h1>
    </header>
    ...
    <div style="margin-top:2.5rem;padding-top:2.2rem;border-top:1px solid rgba(26,22,17,.16);display:flex;justify-content:space-between;align-items:center;flex-wrap:wrap;gap:1.2rem;">
      <p style="font-size:.78rem;color:rgba(26,22,17,.66);font-style:italic;">Prices &amp; offerings may change. See what&rsquo;s on right now on the <a href="/live">live feed</a>.</p>
      <a href="http://adessocoffee.square.site" target="_blank" rel="noopener" style="font-size:.64rem;letter-spacing:.24em;text-transform:uppercase;font-weight:600;background:#ad3829;color:#f2ecdf;padding:1rem 2rem;">Order Online</a>
    </div>
